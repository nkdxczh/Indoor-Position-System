		...
		<ul id="dashboard-menu">
			...
			<li class="active"><a href="tables.html">
					<div class="pointer">
						<div class="arrow"></div>
						<div class="arrow_border"></div>
					</div> <i class="icon-th-large"></i> <span>Tables</span>
			</a></li>
		...
		<div class="container-fluid">
			<div id="pad-wrapper">
							...
							<tbody>
								...
								<tr>
									<td><input type="checkbox" />
										<div class="img">
											<img src="img/table-img.png" />
										</div> <a href="#" class="name">Internet tend</a></td>
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span3"><span class="line"></span> Total amount
									</th>
								</tr>
							</thead>
							<tbody>
								...
								<tr>
									...
									<td><span class="label">Canceled</span></td>
									<td>8</td>
									<td>$ 3,499.99</td>
								</tr>
							</tbody>
				...
				<div class="table-wrapper users-table section">
					...
					<div class="row-fluid filter-block">
						<div class="pull-right">
							<a class="btn-flat pull-right success new-product add-user">+
								Add user</a> <input type="text" class="search user-search"
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span3"><span class="line"></span>Signed up</th>
									<th class="span2"><span class="line"></span>Total spent</th>
									<th class="span3 align-right"><span class="line"></span>Email
									</th>
								</tr>
							</thead>
							<tbody>
								...
								<tr class="first">
									...
									<td>Jan 11, 2012</td>
									<td>$ 500.00</td>
									<td class="align-right"><a href="#">alejandra@gmail.com</a>
									</td>
								</tr>
								<tr>
