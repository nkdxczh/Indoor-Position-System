...
/**
 * Servlet implementation class AGetFriendServlet
 */
public class AGetFriendServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AGetFriendServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		List<User> lstFriend = userBiz.findFriends(user.getId());

		// -------------------响应客户端 JSon----------------
		response.setContentType("text/html; charset=UTF-8");
		response.setCharacterEncoding("UTF-8");
		PrintWriter out = response.getWriter();
		String gson_data = gson.toJson(lstFriend);
